...
public class DepartBeforeArrivalFilterImplTest {
    ...
    @Test
    public void check() {
        assertArrayEquals(testFlightsForFiltering.stream().filter(x -> new DepartBeforeArrivalFilterImpl().check(x)).toArray(), testFlights.toArray());
    }
    ...
    private static List<Flight> buildTestFlights() {
        return Arrays.asList(
                ...
                createFlight(LocalDateTime.of(2021, 6, 17, 2, 53), LocalDateTime.of(2021, 6, 23, 2, 53)),
                //A flight that departs before it arrives
                //createFlight(LocalDateTime.of(2021, 06, 23, 02, 53), LocalDateTime.of(2021, 06, 22, 20, 53)),
                //A flight with more than two hours ground time
                createFlight(LocalDateTime.of(2021, 6, 23, 2, 53), LocalDateTime.of(2021, 6, 23, 4, 53),
                        LocalDateTime.of(2021, 6, 23, 7, 53), LocalDateTime.of(2021, 6, 23, 8, 53)),
                //Another flight with more than two hours ground time
